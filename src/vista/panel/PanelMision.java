 ...
 *
 */
public class PanelMision extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        etTitulo.setText("Misiones disponibles");
        separador.setLeftComponent(etTitulo);

        btnAceptar.setText("Aceptar Mision");
    ...
    public void addControlador(ActionListener al) {
        ...
        btnAceptar.setActionCommand("aceptarMision");
    }

    public void setMisiones(String[] lista) {
        DefaultListModel modelo = new DefaultListModel();

        for (String mision : lista) {
            modelo.addElement(mision);
        }
    ...
    public void setEtTitulo(String titulo) {
        etTitulo.setText(titulo);
    }

    public void setBtnDisponible(boolean disponible) {
        btnAceptar.setEnabled(disponible);
    }
}
